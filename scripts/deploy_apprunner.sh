...
BEDROCK_MODEL_ID="${BEDROCK_MODEL_ID:-anthropic.claude-fable-5}"
BEDROCK_MODEL_FALLBACK_IDS="${BEDROCK_MODEL_FALLBACK_IDS:-anthropic.claude-opus-4-8,eu.anthropic.claude-sonnet-4-5-20250929-v1:0}"
