...
env = {
    ...
    "BEDROCK_MODEL_FALLBACK_IDS": os.environ.get("BEDROCK_MODEL_FALLBACK_IDS", "${BEDROCK_MODEL_FALLBACK_IDS}"),
    "BEDROCK_MAX_TOKENS": os.environ.get("BEDROCK_MAX_TOKENS", "${BEDROCK_MAX_TOKENS}"),
    "BEDROCK_FALLBACK_MAX_TOKENS": os.environ.get("BEDROCK_FALLBACK_MAX_TOKENS", "${BEDROCK_FALLBACK_MAX_TOKENS}"),
