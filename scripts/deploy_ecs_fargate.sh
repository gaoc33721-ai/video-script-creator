...
NOVA_CANVAS_AWS_REGION="${NOVA_CANVAS_AWS_REGION:-us-east-1}"
NOVA_CANVAS_MODEL_ID="${NOVA_CANVAS_MODEL_ID:-amazon.titan-image-generator-v2:0}"
NOVA_CANVAS_ESTIMATED_USD_PER_IMAGE="${NOVA_CANVAS_ESTIMATED_USD_PER_IMAGE:-0.04}"
