...
BEDROCK_MODEL_ID="${BEDROCK_MODEL_ID:-qwen.qwen3-235b-a22b-2507-v1:0}"
BEDROCK_MODEL_FALLBACK_IDS="${BEDROCK_MODEL_FALLBACK_IDS:-openai.gpt-oss-120b-1:0,nvidia.nemotron-super-3-120b,mistral.devstral-2-123b,eu.amazon.nova-pro-v1:0}"
BEDROCK_MAX_TOKENS="${BEDROCK_MAX_TOKENS:-16384}"
BEDROCK_FALLBACK_MAX_TOKENS="${BEDROCK_FALLBACK_MAX_TOKENS:-8192}"
...
VIDEO_SUBMISSION_MIN_INTERVAL_SECONDS="${VIDEO_SUBMISSION_MIN_INTERVAL_SECONDS:-90}"
...
NOVA_CANVAS_REFERENCE_STRENGTH="${NOVA_CANVAS_REFERENCE_STRENGTH:-0.38}"
...
LIBLIBAI_IMG2IMG_TEMPLATE_UUID="${LIBLIBAI_IMG2IMG_TEMPLATE_UUID:-07e00af4fc464c7ab55ff906f8acf1b7}"
...
TOAPIS_VIDEO_MODEL="${TOAPIS_VIDEO_MODEL:-grok-video-3}"
TOAPIS_VIDEO_RESOLUTION="${TOAPIS_VIDEO_RESOLUTION:-1080p}"
TOAPIS_VIDEO_RATIO="${TOAPIS_VIDEO_RATIO:-16:9}"
TOAPIS_VIDEO_DURATION="${TOAPIS_VIDEO_DURATION:-6}"
...
STORYBOARD_LOCAL_PRODUCT_NINEGRID_ENABLED="${STORYBOARD_LOCAL_PRODUCT_NINEGRID_ENABLED:-false}"
...
env = [
    ...
    {"name": "VIDEO_SUBMISSION_MIN_INTERVAL_SECONDS", "value": "${VIDEO_SUBMISSION_MIN_INTERVAL_SECONDS}"},
    ...
    {"name": "LIBLIBAI_IMG2IMG_TEMPLATE_UUID", "value": "${LIBLIBAI_IMG2IMG_TEMPLATE_UUID}"},
    ...
    {"name": "STORYBOARD_LOCAL_PRODUCT_NINEGRID_ENABLED", "value": "${STORYBOARD_LOCAL_PRODUCT_NINEGRID_ENABLED}"},
